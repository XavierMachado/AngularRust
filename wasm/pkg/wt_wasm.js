...
export class WasmFrameDecoder {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WasmFrameDecoderFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmframedecoder_free(ptr, 0);
    }
    /**
     * True when a partial frame is still buffered.
     * @returns {boolean}
     */
    get has_partial_frame() {
        const ret = wasm.wasmframedecoder_has_partial_frame(this.__wbg_ptr);
        return ret !== 0;
    }
    constructor() {
        const ret = wasm.wasmframedecoder_new();
        this.__wbg_ptr = ret;
        WasmFrameDecoderFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    push(chunk) {
        ...
        const ret = wasm.wasmframedecoder_push(this.__wbg_ptr, ptr0, len0);
        if (ret[3]) {
 ...
 * @returns {Uint8Array}
 */
export function encode_frame(json) {
...
export function human_bytes(bytes) {
    ...
    let deferred1_1;
    try {
        const ret = wasm.human_bytes(bytes);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function validate_say(author, text) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.validate_say(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wt_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
