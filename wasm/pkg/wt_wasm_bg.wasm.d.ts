...
export const validate_say: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const wasmframedecoder_has_partial_frame: (a: number) => number;
export const wasmframedecoder_new: () => number;
